 ...
 * 
 * A base class for unit tests where sample source files are loaded from a folder, converted to 
				...
				foreach (string file in files)
					...
					if (Test.IsInputFile(file))
						...
						try
							...
							List<PossibleDocumentationComment> comments = language.GetComments(code);
