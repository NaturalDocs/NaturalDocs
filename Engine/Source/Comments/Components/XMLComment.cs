/* 
 * Class: GregValure.NaturalDocs.Engine.Comments.Components.XMLComment
 * ____________________________________________________________________________
 * 
 * A class to handle the generated output of an XML comment.
 * 
 */
...
namespace GregValure.NaturalDocs.Engine.Comments.Components
	...
	public class XMLComment
		...
		/* __________________________________________________________________________
		 * 
		 * Class: GregValure.NaturalDocs.Engine.Comments.Components.XMLComment.Block
		 * __________________________________________________________________________
		 */
		public class Block
			{
		...
		/* __________________________________________________________________________
		 * 
		 * Struct: GregValure.NaturalDocs.Engine.Comments.Components.XMLComment.TextBlock
		 * __________________________________________________________________________
		 */
		...
		/* __________________________________________________________________________
		 * 
		 * Struct: GregValure.NaturalDocs.Engine.Comments.Components.XMLComment.ListBlock
		 * __________________________________________________________________________
		 */
		...
		/* __________________________________________________________________________
		 * 
		 * Struct: GregValure.NaturalDocs.Engine.Comments.Components.XMLComment.ListItem
		 * __________________________________________________________________________
		 */
