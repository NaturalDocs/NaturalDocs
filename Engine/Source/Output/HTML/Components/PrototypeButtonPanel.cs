...
namespace CodeClear.NaturalDocs.Engine.Output.HTML.Components
	...
	public class PrototypeButtonPanel : HTML.Components.FormattedText
		...
		public bool IsNeededFor (Engine.Topics.Topic topic)
			{
			return HasRepositoryLinks(topic);
			}
		...
		public void AppendButtonPanel (Engine.Topics.Topic topic, StringBuilder output)
			...
			output.Append(
				"<div id=\"NDPrototypeButtonPanel" + Context.Topic.TopicID + "\" class=\"NDPrototype PButtonPanel\" " +
					"onmouseenter=\"NDContentPage.OnPrototypeMouseEnter(event," + topic.TopicID + ");\" " +
					"onmouseleave=\"NDContentPage.OnPrototypeMouseLeave(event," + topic.TopicID + ");\">");
		 ...
		 */
		protected bool HasRepositoryLinks (Engine.Topics.Topic topic)
			{
		 ...
		 *
		 * Class: CodeClear.NaturalDocs.Engine.Output.HTML.Components.PrototypeButtonPanel.RepositoryLink
		 * ____________________________________________________________________________
		 *
