/*
 * Class: CodeClear.NaturalDocs.Engine.Output.HTML.Components.ClassPrototypeButtonPanel
 * ____________________________________________________________________________
 *
 * A reusable class for building HTML button panels attached to class prototypes.
 *
 *
...
namespace CodeClear.NaturalDocs.Engine.Output.HTML.Components
	{
	public class ClassPrototypeButtonPanel : HTML.Components.FormattedText
		{
		...
		/* Constructor: ClassPrototypeButtonPanel
		 */
		public ClassPrototypeButtonPanel (Context context) : base (context)
			{
		 ...
		 */
		public void AppendButtonPanel (Engine.Topics.Topic topic, StringBuilder output, string extraCSSClasses = null)
			{
