...
namespace CodeClear.NaturalDocs.Engine.Languages.Parsers
{
	public class SQL : Language
		...
		static protected StringSet generalKeywords = new StringSet (KeySettings.IgnoreCase, new string[] {
			...
			"SELF", "SEMANTICKEYPHRASETABLE", "SEMANTICSIMILARITYDETAILSTABLE", "SEMANTICSIMILARITYTABLE", "SEPARATE", "SEQUENCE",
			"SERIALIZABLE", "SET", "SETUSER", "SHARE", "SHORT", "SHUTDOWN", "SIZE", "SMALLDATETIME", "SMALLINT", "SMALLMONEY",
			"SOME", "SPARSE", "SQL", "SQLCODE", "SQLDATA", "SQLNAME", "SQLSTATE", "STANDARD", "START", "STATIC", "STATISTICS", 
			"STDDEV", "STORED", "STRING", "STRUCT", "STYLE", "SUBMULTISET", "SUBPARTITION", "SUBSTITUTABLE", "SUBTYPE", "SUM", 
			"SYNONYM", "TABAUTH", "TABLE", "TABLESAMPLE", "TDO", "TEXT", "TEXTSIZE", "THE", "THEN", "TIME", "TIMESTAMP", "TINYINT", 
			"TO", "TOP", "TRAILING", "TRAN", "TRANSACTION", "TRANSACTIONAL", "TRIGGER", "TRUNCATE", "TRUSTED", "TSEQUAL", "TYPE", 
			"UB1", "UB2", "UB4", "UNDER", "UNION", "UNIQUE", "UNPIVOT", "UNPLUG", "UNSIGNED", "UNTRUSTED", "UPDATE", "UPDATETEXT", 
			"UROWID", "USE", "USER", "USING", "VALIST", "VALUE", "VALUES", "VARBINARY", "VARCHAR", "VARCHAR2", "VARIABLE", 
			"VARIANCE", "VARRAY", "VARYING", "VIEW", "VIEWS", "VOID", "WAITFOR", "WHEN", "WHERE", "WHILE", "WITH", "WITHIN GROUP", 
			"WORK", "WRAPPED", "WRITE", "WRITETEXT", "YEAR", "ZONE"
