/*
 * Class: CodeClear.NaturalDocs.Engine.Tests.Framework.BaseTestTypes.SourceToElements
 * ____________________________________________________________________________
 *
 * A base class for automated tests where sample source files are loaded from a folder and converted to
 * <Elements>.  The results of <OutputOf()> are saved to files and compared to other files containing the
 * expected result.
 *
...
namespace CodeClear.NaturalDocs.Engine.Tests.Framework.BaseTestTypes
	{
	public abstract class SourceToElements
		{
		...
		/* Function: OutputOf
		 *
		 * Override this function to generate the output for the passed <Elements>.  The output should be whatever you're
		 ...
		 */
		public abstract string OutputOf (List<Element> elements);
