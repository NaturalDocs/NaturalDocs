...
// We support inline structs but currently don't parse inside their braces for types.
func InlineStruct (x struct { z int })
	{  }
	
// Function: InlineInterface
// We support inline interfaces but currently don't parse inside their braces for types.
