...
@Preliminary @Copyright("Text String")
@RequestForEnhancement(
	id = 2868724,
	engineer = "String",
...
// Function: Multiple_Annotations_and_Parameters
@Copyright("Text String") @Preliminary 
@RequestForEnhancement(
	id = 2868724,
	engineer = "String",
	array = {"string 1", "string 2"}
	) @Endorsers({"String 1", "String 2"}) public 
static void Multiple_Annotations_and_Parameters (int x, string y = "value") { }
